    ...
    <footer className={`${!showHeader && "hidden"} bg-[#e4e8ec] flex flex-col`}>
      <div className="container relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 pt-8 mb-10 gap-y-4">
        <div className="flex flex-col gap-y-4 lg:gap-y-8 px-4 text-left text-sm">
          ...
          <p>
            Chuyên mua bán các loại linh kiện PC – LAPTOP chính hãng tại Sài
            Gòn. Cung cấp hỗ trợ các loại giấy tờ CO, CQ, chứng thư bán hàng.
          </p>
        ...
        <div className="flex flex-col gap-y-4 lg:gap-y-8 px-4 text-left text-sm">
          ...
          <Link href={"/"} className="hover:text-red-500">
            <span>
              <strong>Zalo:</strong> 0986.989.626
            </span>
          </Link>
          <Link href={"/"} className="hover:text-red-500">
            <span>
              <strong>Hotline:</strong> 0986.989.626
            </span>
          </Link>
          <Link href={"/"} className="hover:text-red-500">
            <span>
              <strong>Địa chỉ:</strong> 169/40/1 Nguyen Tư Giản P1 Gò Vấp
            </span>
          </Link>
          <Link href={"/"} className="hover:text-red-500">
            <span>
              <strong>Facebook:</strong> fb.com/laptop
            </span>
          </Link>
          <Link href={"/"} className="hover:text-red-500">
            <span>
              <strong>Gmail:</strong> topweb.com.vn@gmail.com
            </span>
          </Link>
        </div>
        <div className="flex flex-col gap-y-4 lg:gap-y-8 px-4 text-left text-sm">
